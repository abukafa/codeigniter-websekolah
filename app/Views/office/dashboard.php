...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <h4 class="my-5">Pooling Penilaian</h4>
...
<script>
    ...
    const skpA = pooling[0].a;
    const crdA = pooling[1].a;
    const trpA = pooling[2].a;
    const skpB = pooling[0].b;
    const crdB = pooling[1].b;
    const trpB = pooling[2].b;
    const skpC = pooling[0].c;
    const crdC = pooling[1].c;
    const trpC = pooling[2].c;
    const skpD = pooling[0].d;
    const crdD = pooling[1].d;
    const trpD = pooling[2].d;
    ...
    var yourChart = new Chart(cta, {
        ...
        data: {
            ...
            datasets: [{
                    data: [skpA, crdA, trpA],
                    backgroundColor: ['#007bff', '#459fff', '#87c1ff']
                },
                {
                    data: [skpB, crdB, trpB],
                    backgroundColor: ['#20c997', '#4ed3ab', '#8ce0c7']
                },
                {
                    data: [skpC, crdC, trpC],
                    backgroundColor: ['#ffcd39', '#fcd973', '#f7e2a3']
                },
                {
                    data: [skpD, crdD, trpD],
                    backgroundColor: ['#dd3545', '#d35561', '#e98f98']
                }
            ]
        }
    });
