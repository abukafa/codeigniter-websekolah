        ...
        <div class="modal-content">
            ...
            <form action="/member/kompetensi" method="post">
                <div class="modal-body">
                    ...
                    <div class='mb-2'>
                        <label class='form-label' for='hasil'>Hasil / Sebagai..</label>
                        <input type='text' class='form-control' name='hasil' id='hasil' placeholder="Nilai akhir atau Pencapaian atau Kontribusi..">
                    </div>
                    <div class='mb-2'>
