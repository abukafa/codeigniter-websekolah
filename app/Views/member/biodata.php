    ...
    <form action="<?= (!$member) ? '/admin/biodata' : ((session()->get('member')) ? '/member/biodata/' : '/admin/biodata/') . $member['id'] ?>" method="post">
        <div class="row mb-5">
            <div class="<?= (session()->get('member')) ? 'd-none' : ''  ?>">
                ...
                <?php if ($member && $member['akun'] == 'Siswa') { ?>
                    <div class='col-md-12 mb-2'>
                        <label class='form-label' for='ket'>Keterangan</label>
                        <input type='text' class='form-control' name='ket' id='ket' value="<?= ($member) ? $member['ket'] : '' ?>">
                    </div>
                <?php } else { ?>
                    <div class='col-md-12 mb-2'>
            ...
            <div class='col-md-6 mb-2'>
                ...
                <input type='text' class='form-control' name='ni' id='ni' value="<?= ($member) ? $member['ni'] : '' ?>" <?= (session()->get('member')) ? 'readonly' : 'required'  ?>>
            </div>
            <div class='col-md-6 mb-2'>
                <label class='form-label' for='tahun'>Tahun Masuk</label>
                <input type='text' class='form-control' name='tahun' id='tahun' value="<?= ($member) ? $member['tahun'] : '' ?>" <?= (session()->get('member')) ? 'readonly' : 'required'  ?>>
            </div>
            <div class='col-md-6 mb-2'>
            ...
            <div class="row <?= (session()->get('member') > (date('Y') - 3)) ? 'd-none' : ''  ?>">
                <div class='col-md-6 mb-2'>
