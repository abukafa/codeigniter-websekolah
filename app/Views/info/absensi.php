...
$vii_hadir = $viii_hadir = $ix_hadir = 0;
...
$vii_cek = $vii_jumlah - $vii_cek;
$viii_cek = $viii_jumlah - $viii_cek;
$ix_cek = $ix_jumlah - $ix_cek;
?>
        ...
        <div class="row">
            <div class="col-lg-4 mb-2 order-1 order-lg-1">
                <div class="card border-5">
                    ...
                    <div class="card-footer text-muted">
                        <?= ($vii_cek == 0) ? $vii_jumlah . ' siswa' : '<span class="text-danger">' . $vii_cek . ' belum hadir</span>' ?>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-2 order-3 order-lg-2">
                <div class="card border-5">
                    ...
                    <div class="card-footer text-muted">
                        <?= ($viii_cek == 0) ? $viii_jumlah . ' siswa' : '<span class="text-danger">' . $viii_cek . ' belum hadir</span>' ?>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-2 order-5 order-lg-3">
                <div class="card border-5">
                    ...
                    <div class="card-footer text-muted">
                        <?= ($ix_cek == 0) ? $ix_jumlah . ' siswa' : '<span class="text-danger">' . $ix_cek . ' belum hadir</span>' ?>
                    </div>
                </div>
            </div>
